...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    MeterInfo(String meternumber) {
        ...
        meterlocation.add("Urban");
        meterlocation.add("Rural");
        ...
        metertype.add("Single Phase");
        metertype.add("Three Phase");
        metertype.setBounds(240, 160, 200, 20);
        p.add(metertype);
        
        JLabel lblcity = new JLabel("Electricity Supplied");
        lblcity.setBounds(100, 200, 100, 20);
        p.add(lblcity);
        
        phasecode = new Choice();
        phasecode.add("230-400V(LT)");
        phasecode.add("4.6-33KV(HT)");
        phasecode.add("66-400KV(EHT)");
