    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if(rs.next()) {
                ...
                area.append("\n    Electricty Type: " + rs.getString("phase_code"));
            ...
            rs = c.s.executeQuery("select * from bill where meter_no = '"+meter+"' and month='"+month+"' and status='Not Paid'");
            ...
            area.append("\n\tBill not generated for the month of " + month);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
