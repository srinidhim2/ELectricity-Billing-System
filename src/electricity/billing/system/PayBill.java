...
public class PayBill extends JFrame implements ActionListener{
    ...
    PayBill(String meter) {
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from bill where meter_no = '"+meter+"' and  status='Not Paid'");
            while(rs.next()) {
...
//        cmonth.add("December");
        ...
        try {
            ...
            rs = c.s.executeQuery("select * from bill where meter_no = '"+meter+"' AND month = 'Select'");
            if(!rs.next()){
                labelunits.setText("Select a month");
